...
下一版本 v0.4.0 已启用协议 v3：设备使用 Ed25519/X25519 完成身份认证和首次验证码配对，WebSocket 控制消息通过 AES-256-GCM 加密并严格防重放。文件和文件夹 offer 已绑定逐文件 SHA-256，接收端只有在临时内容摘要一致后才发布；HTTP 文件内容分块加密将在阶段 6 完成。完整路线见 [v0.4.0 设计](docs/v0.4.0.md)。
